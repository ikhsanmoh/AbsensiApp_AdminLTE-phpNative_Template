...
<head>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="<? echo $base; ?>plugins/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- Theme style -->
...
<div class="login-box">
  <div class="login-logo">
    <a href="<? echo $base; ?>./app/index.php"><b>Absen</b>App</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <?php if( isset($_GET['status']) ): ?>
        <p>
          <?php
            if( $_GET['status'] == 'email_err' ){
              echo "Username Salah!";
            } elseif ( $_GET['status'] == 'pass_err' ) {
              echo "Password Salah!";
            }
          ?>
        </p>
