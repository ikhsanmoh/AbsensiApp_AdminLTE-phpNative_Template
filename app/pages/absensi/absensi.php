...
<head>
  ...
  <title>Absesnsi App | Absensi</title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<? echo $base; ?>./app/pages/absensi/absensi.php" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        ...
                        <a class="btn btn-warning" href="#" role="button">Cetak</a>
                      </td>
                    </tr>
                    <tr>
                      <th scope="row">2</th>
            ...
            <div class="card card-primary card-outline">
              ...
              <h3 class="h3">Histori Absensi</h3>
                <table class="table table-striped table-sm">
                  <thead>
                    <tr>
                  ...
                  <tbody>
                    <tr>
                      <td>Januari</td>
                      <td>
                        <a class="btn btn-info" href="#" role="button" data-toggle="modal" data-target="#lihatHistoriAbsensi">Lihat</a>
                        <a class="btn btn-warning" href="#" role="button">Cetak</a>
                      </td>
                    </tr>
                    <tr>
        ...
        <!-- Modal Untuk Histori Absensi-->
        <div class="modal fade" id="lihatHistoriAbsensi" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="lihatHistoriAbsensiLabel" aria-hidden="true">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="lihatHistoriAbsensiLabel">Absensi Bulan Januari</h5>
