          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body">
                ...
                <div class="p-2 mb-2">
                  <a class="btn btn-md btn-primary" href="<? echo $base ?>./app/pages/karyawan/add-karyawan.php" role="button">Tambah Karyawan</a>
                </div>
                <table class="table table-striped">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>@mdo</td>
                      <td>
                        <a class="btn btn-default" href="<? echo $base; ?>/app/pages/karyawan/edit-karyawan.php" role="button">Edit</a>
