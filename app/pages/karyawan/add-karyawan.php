...
<head>
  ...
  <title>Absesnsi App | Karyawan</title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<? echo $base; ?>./app/pages/karyawan/karyawan.php" class="nav-link active">
              ...
              <div class="card-body">
                ...
                <form>
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-lg-2 col-form-label">Nama Karyawan</label>
                    <div class="col-lg-10">
                      <input type="text" class="form-control" id="inputEmail3">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="exampleFormControlTextarea1" class="col-lg-2 col-form-label">Jenis Kelamin</label>
                    <div class="col-lg-10">
                  ...
                  <div class="form-group row">
                    <label for="exampleFormControlTextarea1" class="col-lg-2 col-form-label">Jabatan</label>
                    <div class="col-lg-10">
                      <select class="form-control">
                        <option>--- Pilih ---</option>
                        <option>Junior Web Developer</option>
                        <option>UX Desiner</option>
                        <option>Mobile Developer</option>
                      </select>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="exampleFormControlTextarea1" class="col-lg-2 col-form-label">Gaji (Bulanan)</label>
                    <div class="col-lg-10">
                      <input type="number" class="form-control" id="inputEmail3" disabled>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="exampleFormControlTextarea1" class="col-lg-2 col-form-label">Alamat</label>
                    <div class="col-lg-10">
                      <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="exampleFormControlTextarea1" class="col-lg-2 col-form-label">Email</label>
                    <div class="col-lg-10">
                      <input type="text" class="form-control" id="inputEmail3">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="exampleFormControlTextarea1" class="col-lg-2 col-form-label">Nomor Telepon</label>
                    <div class="col-lg-10">
